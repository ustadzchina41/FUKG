...
def validate_seminar_csv(csv_file):
    ...
    with open(csv_file, 'r', newline='', encoding='utf-8') as csvfile:
        ...
        for line_num, row in enumerate(csvreader, start=2):
            ...
            if not pembicara.isupper():
                errors.append(f"Data salah pada baris {line_num}, informasi error: Nama pembicara harus huruf besar semua")
            if '.' in pembicara:
                errors.append(f"Data salah pada baris {line_num}, informasi error: Nama pembicara tidak boleh mengandung titik")
...
csv_path = r'C:\Users\RAJA\project\fukg\fukg_best_practices\seminar\seminar_attribute.csv'
