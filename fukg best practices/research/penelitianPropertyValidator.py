    ...
    with open(csv_file, 'r', newline='', encoding='utf-8') as csvfile:
        ...
        for line_num, row in enumerate(csvreader, start=2):
            ...
            if ',' in peneliti_utama:
                errors.append(f"Data salah pada baris {line_num}, informasi error: Peneliti utama tidak boleh mengandung koma")
            if not re.match(r'^[A-Z][a-z]*(\s[A-Z][a-z]*)*$', peneliti_utama):
                errors.append(f"Data salah pada baris {line_num}, informasi error: Peneliti utama harus Kapital setiap kata")
...
csv_path = r'C:\Users\RAJA\project\fukg\research\penelitian_attribute.csv'
