    ...
    with open(csv_file, 'r', newline='', encoding='utf-8') as csvfile:
        ...
        for line_num, row in enumerate(csvreader, start=2):
            ...
            if ',' in kepala_laboratorium:
                errors.append(f"Data salah pada baris {line_num}, informasi error: Kepala laboratorium tidak boleh mengandung koma")
            if not re.match(r'^[A-Z][a-z]*(\s[A-Z][a-z]*)*$', kepala_laboratorium):
                errors.append(f"Data salah pada baris {line_num}, informasi error: Kepala laboratorium harus Kapital setiap kata")
...
csv_path = r'C:\Users\RAJA\project\fukg\university_laboratory\laboratorium_attribute.csv'
