...
def validate_fakultas_csv(csv_file):
    ...
    with open(csv_path, 'r', newline='', encoding='utf-8') as csvfile:
        ...
        for line_num, row in enumerate(csvreader, start=2):
            ...
            dekan = row[1].strip()
            if not re.match(r'^[A-Z][a-z]*(\s[A-Z][a-z]*)*$', dekan):
                errors.append(f"Data salah pada baris {line_num}, informasi error: Nama dekan harus Kapital setiap kata, tanpa gelar")
...
csv_path = r'C:\Users\RAJA\project\fukg\faculty\fakultas_attribute.csv'
