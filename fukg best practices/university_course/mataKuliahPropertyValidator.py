...
def validate_mata_kuliah_csv(csv_file):
    ...
    with open(csv_path, 'r', newline='', encoding='utf-8') as csvfile:
        ...
        for line_num, row in enumerate(csvreader, start=2):
            ...
            if not re.match(r'^[A-Z][a-z]*(\s[A-Z][a-z]*)*$', dosen_pengajar):
                errors.append(f"Data salah pada baris {line_num}, informasi error: Nama dosen pengajar harus kapital setiap kata, tanpa gelar")
            ...
            if not re.match(r'^[A-Z][a-z]*(\s[A-Z][a-z]*)*$', pustaka):
                errors.append(f"Data salah pada baris {line_num}, informasi error: Pustaka harus kapital setiap kata dan tidak mengandung tanda koma")
...
csv_path = r'C:\Users\RAJA\project\fukg\university_course\mataKuliah_attribute.csv'
