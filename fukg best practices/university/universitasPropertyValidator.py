...
def validate_universitas_csv(csv_file):
    ...
    with open(csv_path, 'r', newline='', encoding='utf-8') as csvfile:
        ...
        for line_num, row in enumerate(csvreader, start=2):
            ...
            rektor = row[1].strip()
            if not re.match(r'^[A-Z][a-z]*(\s[A-Z][a-z]*)*$', rektor):
                errors.append(f"Data salah pada baris {line_num}, informasi error: Nama rektor harus Kapital setiap kata")
...
csv_path = r'C:\Users\RAJA\project\fukg\university\universitas_attribute.csv'
